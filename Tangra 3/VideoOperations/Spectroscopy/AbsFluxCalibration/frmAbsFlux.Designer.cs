namespace Tangra.VideoOperations.Spectroscopy.AbsFluxCalibration
{
	partial class frmAbsFlux
	{
		...
		private void InitializeComponent()
		{
			...
			this.lblUsedSpectraTitle.Size = new System.Drawing.Size(187, 13);
			this.lblUsedSpectraTitle.TabIndex = 1;
			this.lblUsedSpectraTitle.Text = "Used Spectra (doubleclick to exclude)";
			// 
			// pnlDetail
			// 
			...
			this.openFileDialog.Filter = "Tangra Reduced Spectra (*.spectra)|*.spectra|All Files (*.*)|*.*";
			...
			this.Text = "Spectroscopy - Absolute Flux Calibration";
