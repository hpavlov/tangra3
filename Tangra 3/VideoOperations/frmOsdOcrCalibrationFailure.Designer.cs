namespace Tangra.VideoOperations
{
	partial class frmOsdOcrCalibrationFailure
	{
		...
		private void InitializeComponent()
		{
			...
			// btnSendReport
			// 
			this.btnSendReport.Location = new System.Drawing.Point(264, 145);
			...
			this.btnIgnore.Location = new System.Drawing.Point(183, 145);
			...
			this.label2.Text = "If you don\'t see a reason why this has failed then please send an error report us" +
    "ing the button below. This could help in making the OSD reader better.";
			// 
			// lblOsdReaderType
			// 
			...
			this.lblOsdReaderType.Location = new System.Drawing.Point(49, 52);
			...
			this.btnRetry.Location = new System.Drawing.Point(15, 145);
