...
namespace Tangra.KweeVanWoerden
{
    public class AssemblyHelper
    {
        ...
        public static string GetEmbededResource(Assembly callingAssembly, string nameSpace, string fileNameOnly, Encoding encoding)
        {
        ...
        public static string GetEmbededResource(Assembly callingAssembly, string nameSpace, string fileNameOnly, Encoding encoding, Encoding outEncoding)
        {
        ...
        private static Stream GetEmbededResourceStreamThatClientMustDispose(Assembly callingAssembly, string nameSpace, string fileNameOnly)
        {
            ...
            if (data == null) throw new MissingMemberException();
