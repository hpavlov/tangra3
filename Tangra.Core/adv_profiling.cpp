...
int ADVRPF_COMPRESSION_MICROSECS = 0;
int ADVRPF_PROCESSED_FRAMES = 0;
__int64 ADVRPF_HDDWRITE_BYTES_WRITTEN = 0;
int ADVRPF_TOTAL_ADV_PROCESSING_MICROSECS = 0;
int ADVRPF_TOTAL_PROCESSING_MICROSECS = 0;
int ADVRPF_HDD_OPERATION_MICROSECS = 0;
int ADVRPF_BYTE_PROCESSING_MICROSECS = 0;
int ADVRPF_MEMORY_ALLOCATION_MICROSECS = 0;
int ADVRPF_TESTING_MICROSECS = 0;
__int64 ADVRPF_PROFILING_STARTED_TIMESTAMP;
