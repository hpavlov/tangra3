...
namespace Tangra.SDK
{
	...
	public interface ILightCurveDataProvider
	{
        ...
        void SetFoundOccultationEvent(int eventId, float dFrame, float rFrame, float dFrameErrorMinus, float dFrameErrorPlus, float rFrameErrorMinus, float rFrameErrorPlus, string dTime, string rTime, bool cameraDelaysKnownToAOTA, int framesIntegrated);
