namespace Tangra.OccultTools
{
    partial class frmConfig
    {
        ...
        private void InitializeComponent()
        {
			...
			this.label1.Text = "IMPORTANT: While the Occult Tools for OccultWatcher addin is loaded you will not " +
    "be able to update Occult. You will need to stop OccultWatcher before updating Oc" +
    "cult.";
			// 
			// frmConfig
			// 
